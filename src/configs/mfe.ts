...
export const MFE_CONFIGS: MfeConfig[] = [
    {
        ...
        url: 'https://InkRamp.github.io/InkRamp/shell-mfe-buyer/remoteEntry.js',
        route: 'buyer',
    ...
    },
    {
        ...
        remoteName: 'supplier',
        exposedModule: './Component',
        url: 'https://InkRamp.github.io/InkRamp/shell-mfe-supplier/remoteEntry.js',
        route: 'sales',
    ...
    },
    {
        ...
        remoteName: 'admin',
        exposedModule: './Component',
        url: 'https://InkRamp.github.io/InkRamp/shell-mfe-admin/remoteEntry.js',
        route: 'reports',
